...
#'
#' Transatlantic trips occurred often and began in the late 1400s.  By sail, the eastward trip took about 30 to 45 days and the westward trip 65 to 90 days.  From wikipedia, "The Blue Riband is an unofficial accolade given to the passenger liner crossing the Atlantic Ocean in regular service with the record highest average speed. The record is based on average speed rather than passage time because ships follow different routes." Eastbound and westbound trips are treated differently as easbound passages are assisted by the Gulf Stream and favorable weather systems. The significance of the Blue Riband dataset is that it documents the evolution from sail to steam to diesel.  Transport speeds were seen as militarily strategic and economically important. Thus, many nations funded the building of the ships.
#'
