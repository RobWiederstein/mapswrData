...
#'
#' @format A data frame with 178 rows and 9 columns:
#' \describe{
...
#'
#'
#' @details This dataset is the illustrative dataset for the `mapdeck` package and was ported from the `plotly` GitHub account. To avoid the creation of a dependency and  a possible broken link, the dataset was preserved here.  The original source was provided under an MIT license.
#'
#' @source 'https://raw.githubusercontent.com/plotly/datasets/master/2011_february_aa_flight_paths.csv'
#'
#'
#' @examples
#'
